        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    Text("RM 1,240.50", color = Color(0xFF3A7BC8), fontSize = 26.sp, fontWeight = FontWeight.SemiBold)
                    ...
                    Box(
                        ...
                        Column {
                            ...
                            Text("Oct 31", color = Color.White, fontSize = 24.sp, fontWeight = FontWeight.SemiBold)
                        }
                    }
                }
            }
            ...
            item {
                Column(
                    ...
                    Text("September 2023\nStatement", color = Color(0xFF3A7BC8), fontSize = 28.sp, lineHeight = 30.sp, fontWeight = FontWeight.SemiBold)
                    Text(
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                        Text("RM 8,450.00", color = Color(0xFF2F80ED), fontSize = 34.sp, fontWeight = FontWeight.SemiBold)
                        Button(
                            onClick = { },
