...
interface AppStrings {
    ...
    val welcomeBack: String get() = "Welcome Back"
    val helloUser: (String) -> String get() = { "Hello, $it" }
    val deliveryInProgressStatus: String get() = "Your delivery is in progress"
    val arrivingInApproxMins: (String) -> String get() = { "Arriving in approx. $it mins" }
    val driverDetailsUpdating: String get() = "Driver details updating"
    val trackNow: String get() = "Track now"
    val noActiveDeliveriesRightNow: String get() = "No active deliveries right now"
    val sendAPackage: String get() = "Send a Package"
    ...
    val enterPickupLocation: String get() = "Enter pickup location"
    val deliveryLocation: String get() = "Delivery Location"
    val enterDeliveryAddress: String get() = "Enter delivery address"
    val whereShouldWeDeliver: String get() = "Where should we deliver?"
    val selectValidDropLocation: String get() = "Select a valid drop location from suggestions to continue"
    val recentDeliveries: String get() = "Recent Deliveries"
    val noRecentDeliveries: String get() = "No recent deliveries"
    val routeTitle: (String, String) -> String get() = { pickup, delivery -> "$pickup to $delivery" }
    val deliveredOn: (String) -> String get() = { "Delivered on $it" }
    val repeat: String get() = "Repeat"
    ...
    val personalInfo: String get() = "Personal Info"
    val paymentsAndWallet: String get() = "Payments & Wallet"
    val privacyAndSecurity: String get() = "Privacy & Security"
    val totalShipments: String get() = "Total Shipments"
    val userRating: String get() = "User Rating"
    val verified: String get() = "Verified"
    val deliveries: String get() = "Deliveries"
    ...
    val languageSettingsDescription: String get() = "Select your preferred language for the\napplication interface."
    val globalConnectivityTitle: String get() = "Global Connectivity"
    val globalConnectivityDescription: String get() = "Experience our services in your native\nlanguage for a more intuitive and\npersonalized delivery journey."
    val activeProfile: String get() = "Active Profile"
    val logisticsManager: String get() = "Logistics Manager"
    val deliveryPreferences: String get() = "Delivery Preferences"
    val savedAddress: String get() = "Saved address"
    val defaultVehicle: String get() = "Default Vehicle"
    val defaultVehicleDescription: String get() = "Select your most frequent delivery type"
    val bike: String get() = "Bike"
    val car: String get() = "Car"
    val van: String get() = "Van"
    val bikeDescription: String get() = "Small packages up to\n5 kg. Ideal for\ndocuments, food, and\nurgent city deliveries."
    val carDescription: String get() = "Medium loads 5-20\nkg. Best for grocery\nhauls and multiple\nmedium-sized boxes."
    val vanDescription: String get() = "Bulk shipments.\nPerfect for furniture,\nlarge appliances, or\nbusiness inventory."
    val savePreferences: String get() = "Save Preferences"
    val selected: String get() = "Selected"
    val appAutomation: String get() = "App Automation"
    val autoApplyCoupons: String get() = "Auto-apply coupons"
    val saveLastAddress: String get() = "Save last address"
    val dataAndSecurity: String get() = "Data & Security"
    val clearCache: String get() = "Clear cache"
    val dataSaverMode: String get() = "Data saver mode"
    val carryOnLogistics: String get() = "CarryOn Logistics"
    ...
    val noSavedAddressesYet: String get() = "No saved addresses yet."
    val frequentLocations: String get() = "Frequent Locations"
    val addressUnavailable: String get() = "Address unavailable"
    ...
    val accountSecurity: String get() = "Account Security"
    val loginAndAccess: String get() = "Login & Access"
    val loggedInDevices: String get() = "Logged in devices"
    val permissions: String get() = "Permissions"
    val locationAccess: String get() = "Location Access"
    val dataAndPrivacy: String get() = "Data & Privacy"
    val downloadMyData: String get() = "Download my data"
    val dangerZone: String get() = "Danger Zone"
    val deleteAccount: String get() = "Delete Account"
    val deleteAccountWarning: String get() = "Deleting your account is permanent. All your\ndelivery history, addresses, and saved data will be\nremoved."
