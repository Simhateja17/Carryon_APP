...
object TaStrings : AppStrings {
    ...
    override val welcomeBack = "மீண்டும் வரவேற்கிறோம்"
    override val helloUser: (String) -> String = { "வணக்கம், $it" }
    override val deliveryInProgressStatus = "உங்கள் டெலிவரி நடைபெற்று வருகிறது"
    override val arrivingInApproxMins: (String) -> String = { "சுமார் $it நிமிடங்களில் வரும்" }
    override val driverDetailsUpdating = "ஓட்டுநர் விவரங்கள் புதுப்பிக்கப்படுகின்றன"
    override val trackNow = "இப்போது கண்காணி"
    override val noActiveDeliveriesRightNow = "இப்போது செயலில் டெலிவரிகள் இல்லை"
    override val sendAPackage = "பொருளை அனுப்பு"
    ...
    override val enterPickupLocation = "பிக்அப் இடத்தை உள்ளிடவும்"
    override val deliveryLocation = "டெலிவரி இடம்"
    override val enterDeliveryAddress = "டெலிவரி முகவரியை உள்ளிடவும்"
    override val whereShouldWeDeliver = "எங்கே டெலிவரி செய்ய வேண்டும்?"
    override val selectValidDropLocation = "தொடர, பரிந்துரைகளிலிருந்து சரியான டிராப் இடத்தைத் தேர்வு செய்யவும்"
    override val recentDeliveries = "சமீபத்திய டெலிவரிகள்"
    override val noRecentDeliveries = "சமீபத்திய டெலிவரிகள் இல்லை"
    override val routeTitle: (String, String) -> String = { pickup, delivery -> "$pickup முதல் $delivery வரை" }
    override val deliveredOn: (String) -> String = { "$it அன்று டெலிவரி செய்யப்பட்டது" }
    override val repeat = "மீண்டும் செய்"
    ...
    override val personalInfo = "தனிப்பட்ட தகவல்"
    override val paymentsAndWallet = "பணம் & பணப்பை"
    override val privacyAndSecurity = "தனியுரிமை & பாதுகாப்பு"
    override val totalShipments = "மொத்த டெலிவரிகள்"
    override val userRating = "பயனர் மதிப்பீடு"
    override val verified = "சரிபார்க்கப்பட்டது"
    override val deliveries = "டெலிவரிகள்"
    ...
    override val languageSettingsDescription = "பயன்பாட்டு இடைமுகத்திற்கு உங்களுக்கு\nவிருப்பமான மொழியைத் தேர்வு செய்யவும்."
    override val globalConnectivityTitle = "உலகளாவிய இணைப்பு"
    override val globalConnectivityDescription = "உங்கள் சொந்த மொழியில் எங்கள் சேவைகளை\nஅனுபவித்து, மேலும் எளிதான மற்றும்\nதனிப்பயனாக்கப்பட்ட டெலிவரி பயணத்தைப் பெறுங்கள்."
    override val activeProfile = "செயலில் உள்ள சுயவிவரம்"
    override val logisticsManager = "லாஜிஸ்டிக்ஸ் மேலாளர்"
    override val deliveryPreferences = "டெலிவரி விருப்பங்கள்"
    override val savedAddress = "சேமித்த முகவரி"
    override val defaultVehicle = "இயல்புநிலை வாகனம்"
    override val defaultVehicleDescription = "நீங்கள் அதிகம் பயன்படுத்தும் டெலிவரி வகையைத் தேர்வு செய்யவும்"
    override val bike = "பைக்"
    override val car = "கார்"
    override val van = "வேன்"
    override val bikeDescription = "5 கிலோ வரை சிறிய\nபொட்டலங்கள். ஆவணங்கள்,\nஉணவு மற்றும் அவசர நகர\nடெலிவரிகளுக்கு சிறந்தது."
    override val carDescription = "5-20 கிலோ நடுத்தர\nஏற்றங்கள். மளிகை பொருட்கள்\nமற்றும் பல நடுத்தர பெட்டிகளுக்கு\nசிறந்தது."
    override val vanDescription = "பெரிய ஏற்றுமதிகள்.\nமரச்சாமான்கள், பெரிய சாதனங்கள்\nஅல்லது வணிக சரக்குகளுக்கு\nபொருத்தமானது."
    override val savePreferences = "விருப்பங்களை சேமி"
    override val selected = "தேர்வு செய்யப்பட்டது"
    override val appAutomation = "ஆப் தானியக்கம்"
    override val autoApplyCoupons = "கூப்பன்களை தானாக பயன்படுத்து"
    override val saveLastAddress = "கடைசி முகவரியை சேமி"
    override val dataAndSecurity = "தரவு & பாதுகாப்பு"
    override val clearCache = "கேஷை அழி"
    override val dataSaverMode = "தரவு சேமிப்பு முறை"
    override val carryOnLogistics = "CarryOn லாஜிஸ்டிக்ஸ்"
    ...
    override val noSavedAddressesYet = "இன்னும் சேமித்த முகவரிகள் இல்லை."
    override val frequentLocations = "அடிக்கடி பயன்படுத்தும் இடங்கள்"
    override val addressUnavailable = "முகவரி கிடைக்கவில்லை"
    ...
    override val accountSecurity = "கணக்கு பாதுகாப்பு"
    override val loginAndAccess = "உள்நுழைவு & அணுகல்"
    override val loggedInDevices = "உள்நுழைந்த சாதனங்கள்"
    override val permissions = "அனுமதிகள்"
    override val locationAccess = "இருப்பிட அணுகல்"
    override val dataAndPrivacy = "தரவு & தனியுரிமை"
    override val downloadMyData = "என் தரவை பதிவிறக்கு"
    override val dangerZone = "ஆபத்து பகுதி"
    override val deleteAccount = "கணக்கை நீக்கு"
    override val deleteAccountWarning = "உங்கள் கணக்கை நீக்குவது நிரந்தரம். உங்கள்\nடெலிவரி வரலாறு, முகவரிகள் மற்றும் சேமித்த தரவு\nஅனைத்தும் நீக்கப்படும்."
