...
object ZhStrings : AppStrings {
    ...
    override val welcomeBack = "欢迎回来"
    override val helloUser: (String) -> String = { "您好，$it" }
    override val deliveryInProgressStatus = "您的配送正在进行中"
    override val arrivingInApproxMins: (String) -> String = { "预计约 $it 分钟后到达" }
    override val driverDetailsUpdating = "司机信息正在更新"
    override val trackNow = "立即追踪"
    override val noActiveDeliveriesRightNow = "当前没有进行中的配送"
    override val sendAPackage = "寄送包裹"
    ...
    override val enterPickupLocation = "输入取件地点"
    override val deliveryLocation = "配送地点"
    override val enterDeliveryAddress = "输入配送地址"
    override val whereShouldWeDeliver = "要送到哪里？"
    override val selectValidDropLocation = "请从建议中选择有效的送达地点以继续"
    override val recentDeliveries = "近期配送"
    override val noRecentDeliveries = "暂无近期配送"
    override val routeTitle: (String, String) -> String = { pickup, delivery -> "$pickup 到 $delivery" }
    override val deliveredOn: (String) -> String = { "已于 $it 送达" }
    override val repeat = "再次下单"
    ...
    override val personalInfo = "个人信息"
    override val paymentsAndWallet = "支付与钱包"
    override val privacyAndSecurity = "隐私与安全"
    override val totalShipments = "总配送数"
    override val userRating = "用户评分"
    override val verified = "已验证"
    override val deliveries = "配送"
    ...
    override val languageSettingsDescription = "选择您偏好的应用界面语言。"
    override val globalConnectivityTitle = "全球连接"
    override val globalConnectivityDescription = "使用您的母语体验我们的服务，\n让配送旅程更直观、更个性化。"
    override val activeProfile = "活跃资料"
    override val logisticsManager = "物流经理"
    override val deliveryPreferences = "配送偏好"
    override val savedAddress = "已保存地址"
    override val defaultVehicle = "默认车辆"
    override val defaultVehicleDescription = "选择您最常用的配送类型"
    override val bike = "摩托车"
    override val car = "汽车"
    override val van = "货车"
    override val bikeDescription = "最多 5 公斤的小包裹。\n适合文件、餐食和\n紧急城市配送。"
    override val carDescription = "5-20 公斤中等货物。\n适合杂货和多个\n中型箱子。"
    override val vanDescription = "大件货物。\n适合家具、大型电器\n或商业库存。"
    override val savePreferences = "保存偏好"
    override val selected = "已选择"
    override val appAutomation = "应用自动化"
    override val autoApplyCoupons = "自动使用优惠券"
    override val saveLastAddress = "保存上次地址"
    override val dataAndSecurity = "数据与安全"
    override val clearCache = "清除缓存"
    override val dataSaverMode = "省流量模式"
    override val carryOnLogistics = "CarryOn 物流"
    ...
    override val noSavedAddressesYet = "暂无已保存地址。"
    override val frequentLocations = "常用地点"
    override val addressUnavailable = "地址不可用"
    ...
    override val accountSecurity = "账户安全"
    override val loginAndAccess = "登录与访问"
    override val loggedInDevices = "已登录设备"
    override val permissions = "权限"
    override val locationAccess = "位置访问"
    override val dataAndPrivacy = "数据与隐私"
    override val downloadMyData = "下载我的数据"
    override val dangerZone = "危险区域"
    override val deleteAccount = "删除账户"
    override val deleteAccountWarning = "删除账户是永久操作。您的\n配送记录、地址和已保存数据\n都将被移除。"
