...
object SupportedLanguages {
    ...
    val all = listOf(
        SupportedLanguage("en", "English", "English", "Default language", "A"),
        SupportedLanguage("ms", "Malay", "Bahasa Melayu", "Bahasa Melayu", "B"),
    ...
    fun displayName(code: String): String {
        return all.firstOrNull { it.code == normalize(code) }?.englishName ?: "English"
    }
}
